...
namespace ControleMedicamentos.ConsoleApp
{
    internal class Program
    {
        ...
        RepositorioSaidaMedicamento repositorioSaidaMedicamento)
        {
            ...
            Funcionario funcionario1 = new Funcionario("Caio Valle", "valle", "123");
            Funcionario funcionario2 = new Funcionario("Davi Souza", "souza", "456");
            ...
            Paciente paciente1 = new Paciente("João Kleber", "741258963");
            Paciente paciente2 = new Paciente("Camila Rocha", "582147852");
            Paciente paciente3 = new Paciente("Leandro Souza", "111111111");
            Paciente paciente4 = new Paciente("Mario Ferrari", "222222222");
